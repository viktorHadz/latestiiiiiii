...
d(
  ...
  (e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
    typeof n == 'function' && (n = i(n)),
      n !== !1 && (!n || typeof n == 'boolean' ? qn(e, r, t) : Vn(e, n, t))
  },
)
function Vn(e, t, r) {
  Sr(e, pe, ''),
...
function on(e = !1, t = !1) {
  return function (n, i, o) {
    ...
    if (i === '__v_raw' && o === (e ? (t ? Ii : ln) : t ? Pi : cn).get(n))
      return n
    let s = H(n)
...
function bi(e = !1) {
  return function (r, n, i, o) {
    ...
    return (
      r === h(o) && (a ? Nt(i, s) && q(r, 'set', n, i, s) : q(r, 'add', n, i)),
      c
    )
  }
}
...
function Yr(e, t) {
  ...
  let s = i.call(r, e)
  return (
    r.set(e, t), o ? Nt(t, s) && q(r, 'set', e, t, s) : q(r, 'add', e, t), this
  )
}
function Xr(e) {
  let t = h(this),
...
y(
  'refs',
  e => (e._x_refs_proxy || (e._x_refs_proxy = F($i(e))), e._x_refs_proxy),
)
function $i(e) {
  let t = []
  return (
...
d('model', (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
  ...
  let c = () => {
    ...
    l = m => {
      let w
      s($ => (w = $)),
        xn(w) ? w.set(m) : a(() => {}, { scope: { __placeholder: m } })
    }
  typeof r == 'string' &&
    e.type === 'radio' &&
    _(() => {
...
function Ji(e, t, r, n) {
  let i = s => typeof s == 'object' && !Array.isArray(s),
    o = e
  r(s => {
    Xi(s) && s >= 0 && (s = Array.from(Array(s).keys(), f => f + 1)),
      s === void 0 && (s = [])
    let a = e._x_lookup,
      c = e._x_prevKeys,
      l = [],
